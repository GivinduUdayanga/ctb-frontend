...
export default  function LocalTeaNews() {

//     const sampleNews = [
//     {
//         id: 1,
//         title: "Weekly Tea Auction Highlights",
//         image: "/news-png/localnews1.webp",
//         shortDescription:
//         "Key highlights from this week's Colombo Tea Auction, including price movements and buyer demand.",
//         fullDescription:
//         "Key highlights from this week's Colombo Tea Auction, including price movements, buyer demand, and notable lots sold. The auction reflected strong interest from both local and international buyers, with premium grades achieving competitive prices.",
//     },
...
useEffect(() => {
    axios.get("http://localhost:3000/api/admin/local-tea-news")
        .then(res => {
                ...
                <div className="absolute inset-0 bg-black/20 z-10"></div>
                    ...
                    <div className="max-w-7xl mx-auto px-6 py-12">
                        ...
                        <div className="py-20 text-center mb-10">
                            ...
                            ____________ Local Tea News ____________
                            </h1>
                        </div>
