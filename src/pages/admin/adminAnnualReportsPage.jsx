                                    ...
                                    <button 
                                        onClick={
                                            ()=> {
                                                ...
                                                axios.delete(`http://localhost:3000/api/admin/annual-reports/${item.reportID}` , {
                                                    headers: {
                                                    ...
                                                    ()=> {
                                                        ...
                                                        setAnnualReports(
                                                            annualReports.filter(report => report.reportID !== item.reportID)
                                                        );
                                                    }
                                                ).catch((error) => {
                                                    console.log(error);
