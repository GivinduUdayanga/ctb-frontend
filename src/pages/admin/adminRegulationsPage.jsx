                                    ...
                                    <button 
                                        onClick={
                                            ()=> {
                                                ...
                                                axios.delete(`http://localhost:3000/api/admin/regulations/${item.reportID}` , {
                                                    headers: {
                                                    ...
                                                    ()=> {
                                                        ...
                                                        setRegulations(
                                                            regulations.filter(report => report.reportID !== item.reportID)
                                                        );
                                                    }
                                                ).catch((error) => {
                                                    console.log(error);
